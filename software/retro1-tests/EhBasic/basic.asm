...
LAB_1609
	CMP	#(TK_TAB-$80)*2	; compare normalised token * 2 with TAB STACHE commented out
	BCS	LAB_15D9		; branch if A>=TAB (do syntax error then warm start) stache commented out
