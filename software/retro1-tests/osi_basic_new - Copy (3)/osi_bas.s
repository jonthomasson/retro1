...
;.segment "CODE"
;.org $C000 commented out by stache
...
MONCOUT:
    JSR ACIA_WRITE ;write character
	;PHA                ;save A
...
;SerialOutWait:
	...
	;AND	#10            ;mask bit 4.
	;BEQ	SerialOutWait  ;ACIA not done yet, wait...
	;PLA                ;restore A
	RTS

MONRDKEY:
    ;JMP NoDataIn ;will hook up later
    JSR ACIA_GETCHAR
	;LDA	ACIAStatus
	;AND	#1
	;CMP	#1
