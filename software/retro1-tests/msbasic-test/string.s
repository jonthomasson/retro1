...
; ----------------------------------------------------------------------------
STRLIT:
.ifdef OSI ;stache added
        ;if we get here, a should have low message byte
        ;and y should have high message byte
        
        sta MSGL ;store to low message register
        sty MSGH ;store y to high message register
        jsr ACIA_SHWMSG
